            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="complaintsUsers">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#complaintsUsersAria" aria-expanded="false"
                            aria-controls="complaintsUsersAria">
        ...
        if ($commentsComplaints !== []):
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="complaintsComments">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#complaintsCommentsAria" aria-expanded="false"
                            aria-controls="complaintsCommentsAria">
                ...
                <div id="complaintsCommentsAria" class="accordion-collapse collapse"
                     aria-labelledby="complaintsComments">
                    <div class="accordion-body">
                        <?php
        ...
        if ($postsComplaints !== []):
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="complaintsPosts">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#complaintsPostsAria" aria-expanded="false"
                            aria-controls="complaintsPostsAria">
                        Жалобы на посты
                        <span class="badge bg-danger mx-1">
