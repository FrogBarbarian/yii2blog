...
<div class='modal fade show' id='modalWindow' tabindex='-1' aria-modal='true' style='display: block;z-index: 10001'>
    <div class='modal-dialog modal-dialog-centered'>
        <div class='modal-content rounded-0' style='border-color: black'>
            <div class='modal-header'>
                <h1 class='modal-title fs-5'>Отправить жалобу</h1>
                <button type='button' onclick='closeModalDiv()' class='btn-close'  aria-label = 'Close' ></button>
            </div>
                <?php
                $options = [
            ...
            <div class='modal-footer'>
                <button type='button' onclick='closeModalDiv()' class='btn' >
                    Отмена
                </button>
